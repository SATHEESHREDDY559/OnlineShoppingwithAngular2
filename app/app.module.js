...
var product_serviceguard_1 = require("./products/product-serviceguard");
    ...
    core_1.NgModule({
        imports: [
            ...
            router_1.RouterModule.forRoot([
                ...
                { path: 'product/:id',
                    canActivate: [product_serviceguard_1.ProductDetailsGuard],
        ...
        providers: [product_serviceguard_1.ProductDetailsGuard],
